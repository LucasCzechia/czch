...
export default function ContactPage({ activeTab, setActiveTab }) {
  return (
    <>
      ...
      <div className="p-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <a 
              href="https://discord.com/users/lucasczch" 
              target="_blank" 
          ...
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <a 
              href="https://github.com/LucasCzechia" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="hover:text-white transition-colors text-xs"
            >
